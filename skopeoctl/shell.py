...
from skopeoctl import constants, http
...
from skopeoctl.api.quay import QuayRegisterV2
from skopeoctl.logger import logger
from skopeoctl.render import Render
    ...
    def init_source_registry_api(self, registry_url, repo=None):
        ...
        if self._source_registry is None:
            if registry_url.startswith('gcr.io'):
                ...
                self._source_registry = GoogleContainerRegisterV2(registry_url='https://registry.k8s.io', project=repo)
